<?php
/**
 * Copyright 2017 J4Numbers (j4numbers@gmail.com)
 *
...
use j4numbers\Database\DataBase;

$database = new DataBase($home_dir, DATABASE);

if ($_FILES['inputDevelCover']['name'] == "")
{
    $cover_hash = "https://j4numbers.co.uk/assets/images/devel/blank.png";
}
else
{
    ...
    $cover_hash = "https://j4numbers.co.uk/assets/images/devel/" . $hash;
}
